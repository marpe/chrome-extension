 ...
 <div v-if="hasUserScripts">
   <div class="flex flex-col gap-4">
     ...
     <div class="flex gap-4">
       <button ref="saveButton" class="btn-outlined" @click="save">
         <i-lucide-save /> Save
       </button>
       <button ref="resetButton" :disabled="!isModified" class="btn-outlined" @click="reset">
         <i-lucide-undo /> Reset
       </button>
     </div>
   </div>
         ...
         <div class="modal-layout">
           <div class="modal flex flex-col gap-4 modal-card">
             ...
             <div class="flex flex-row justify-end gap-4">
               ...
               <button class="btn-outlined" @click="confirmModal(false)">
                 No
               </button>
             </div>
           </div>
